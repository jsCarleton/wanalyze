  (func (;181;) (type 14) (param i32 i64 i64 i32)
    (local i32)
0 ------------------------------------------------------------
0000    global.get 0
0001    i32.const 80
...
0017        call 32
0018        local.get 4
0019        i64.load offset=40
0020        local.set 2
0021        local.get 4
0022        i64.load offset=32
0023        local.set 1
0024        local.get 3
...
0050        local.set 3
0051        local.get 4
0052        i64.load offset=24
0053        local.set 2
0054        local.get 4
0055        i64.load offset=16
0056        local.set 1
0057        br 1 (;@1;)
6 ------------------------------------------------------------
0058      end
...
0070      call 32
0071      local.get 4
0072      i64.load offset=72
0073      local.set 2
0074      local.get 4
0075      i64.load offset=64
0076      local.set 1
0077      local.get 3
...
0103      local.set 3
0104      local.get 4
0105      i64.load offset=56
0106      local.set 2
0107      local.get 4
0108      i64.load offset=48
0109      local.set 1
0110    end
12 ------------------------------------------------------------
0111    local.get 4
...
0122    local.get 0
0123    local.get 4
0124    i64.load offset=8
0125    i64.store offset=8
0126    local.get 0
0127    local.get 4
0128    i64.load
0129    i64.store
