...
8 ------------------------------------------------------------
0074    local.get 0
0075    i32.load offset=60
0076    local.set 2
0077    local.get 0
0078    i32.load offset=24
0079    local.tee 1
0080    local.get 1
0081    i32.load
0082    local.tee 3
...
17 ------------------------------------------------------------
0159      local.get 0
0160      i32.load offset=32
0161      i32.const 65535
0162      i32.le_s
0163      if  ;; label = @2
18 ------------------------------------------------------------
0164        local.get 0
0165        i32.load offset=28
...
0173      i64.store offset=20 align=4
0174      local.get 0
0175      local.get 0
0176      i32.load
0177      i32.load
...
21 ------------------------------------------------------------
0180    local.get 0
0181    i32.load offset=56
0182    local.set 2
0183    local.get 0
0184    i32.load offset=24
0185    local.tee 1
0186    local.get 1
0187    i32.load
0188    local.tee 3
...
33 ------------------------------------------------------------
0299    local.get 0
0300    i32.load offset=28
0301    local.set 2
0302    local.get 0
0303    i32.load offset=24
0304    local.tee 1
0305    local.get 1
0306    i32.load
0307    local.tee 3
...
0316    local.get 1
0317    local.get 1
0318    i32.load offset=4
0319    i32.const -1
0320    i32.add
0321    local.tee 3
0322    i32.store offset=4
0323    block  ;; label = @1
34 ------------------------------------------------------------
0324      local.get 3
0325      br_if 0 (;@1;)
...
0353    local.get 1
0354    local.get 1
0355    i32.load offset=4
0356    i32.const -1
0357    i32.add
0358    local.tee 2
0359    i32.store offset=4
0360    block  ;; label = @1
38 ------------------------------------------------------------
0361      local.get 2
0362      br_if 0 (;@1;)
...
45 ------------------------------------------------------------
0418    local.get 0
0419    i32.load offset=60
0420    i32.const 1
0421    i32.ge_s
0422    if  ;; label = @1
46 ------------------------------------------------------------
0423      local.get 0
0424      i32.load offset=68
0425      local.set 1
0426      i32.const 0
0427      local.set 3
0428      loop  ;; label = @2
...
51 ------------------------------------------------------------
0469        local.get 1
0470        i32.load offset=12
0471        local.set 4
0472        local.get 1
0473        i32.load offset=8
0474        local.set 5
0475        local.get 0
...
0491        local.get 2
0492        local.get 2
0493        i32.load offset=4
0494        i32.const -1
0495        i32.add
0496        local.tee 4
0497        i32.store offset=4
0498        block  ;; label = @3
52 ------------------------------------------------------------
0499          local.get 4
0500          br_if 0 (;@3;)
