...
var wasmBinaryFile;
  wasmBinaryFile = 'tail_call_bad.wasm';
...
/** @type {function(...*):?} */
var _caller = Module["_caller"] = createExportWrapper("caller");

/** @type {function(...*):?} */
var _callee = Module["_callee"] = createExportWrapper("callee");
